...
**6인 팀의 프론트엔드를 혼자 맡아 실시간 멀티플레이 게임 플랫폼을 완성했습니다.**<br>
리뷰어가 없었기 때문에, 품질은 리뷰 대신 테스트 · 린트 · 훅이 지키게 만들었습니다.
...
<sub>2026.07 – 08 · 6인 팀 (BE 3 · AI 1 · Infra 1 · <b>FE 1, 본인 단독</b>) · 3.5주 · FE 약 52,000 LOC</sub>

| | |
|---|---|
| **문제** | 프론트엔드 리뷰어가 없어, 회귀를 사람이 걸러낼 수 없었습니다. |
| **결정** | 전체 `src`를 분모로 두는 커버리지 래칫, WebSocket 페이크와 실서버를 각각 겨냥한 Playwright 2단 E2E, Biome 정적 분석, dpdm 순환 의존성 검사를 세웠습니다. |
...
| | | |
|---|---|---|
| **FestiFriends**<br><sub>공연 예매 · 모임</sub> | 8인 팀 · 형상관리 · 컨벤션 담당. 규칙을 문서가 아니라 린트와 husky pre-push로 강제해, 위반이 리뷰가 아니라 훅에서 걸립니다. | [Demo](https://ff-frontend-rust.vercel.app/) · [Code](https://github.com/FestiFriends/ff_frontend) · [커밋](https://github.com/FestiFriends/ff_frontend/commits?author=jadewisemann) |
| **Pookjayo**<br><sub>숙박 예약</sub> | 5인 팀장/PM. 결제 검증과 예약 체결을 Cloud Functions로 옮기고 단일 Firestore 트랜잭션으로 묶어, 클라이언트 값을 신뢰하는 지점을 없앴습니다. | [Demo](https://pookjayo.vercel.app/) · [Code](https://github.com/jadewisemann/Pookjayo) |
